#!/usr/bin/env node
    const { createProjectFiles,addCustomNPMCommand,installClientappDependancies,addSwaggerUIPackage,overwriteProgramFile,editViteConfig,editNetLaunchSettings } = require('./ezViteNetFunctions');
